...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/ydQ22hSMBC)
...
```sh
npx nx serve innomize-tour
```

To create a production bundle:

```sh
npx nx build innomize-tour
```

To see all available targets to run for a project, run:

```sh
npx nx show project innomize-tour
```
